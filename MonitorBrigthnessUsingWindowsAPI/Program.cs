...
namespace MonitorBrigthnessUsingWindowsAPI
{
    ...
    public class Program
    {
        ...
        {
            PhisicalMonitorBrightnessController phisicalMonitorBrightnessController = new PhisicalMonitorBrightnessController();
            phisicalMonitorBrightnessController.Set(200);
        }
    }
